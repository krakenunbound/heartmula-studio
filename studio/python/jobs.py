...
class JobManager:
    ...
    def submit(self, kind: str, params: dict[str, Any], fn: JobFn) -> Job:
        ...
        queued = {
                "heartmula": "Queued HeartMuLa job %s",
    ...
    def _loop(self) -> None:
        while True:
            ...
            opening = {
                "heartmula": "Submitting to HeartMuLa", "cover_art": "Starting cover art",
            ...
            try:
                ...
                if job.cancel.is_set():
                    ...
                    finished = {"heartmula": "Song ready", "cover_art": "Cover art ready", "stems": "Stems ready", "audio_export": "Download ready", "lyrics_sync": "Timed lyrics ready", "stable_sfx": "Sound effect ready"}.get(job.kind, "Complete")
