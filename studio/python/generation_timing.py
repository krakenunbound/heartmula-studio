"""Phase-aware, locally learned generation timing for HeartMuLa.

The autoregressive HeartMuLa counter is a maximum, not a promise that every song
...
def _duration_factor(request: dict) -> float:
    # Auto mode deliberately gives HeartMuLa the full five-minute ceiling.  A
