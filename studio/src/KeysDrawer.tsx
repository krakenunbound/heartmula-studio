...
export default function KeysDrawer({
  ...
  return <aside className="keys-drawer left-drawer" style={{ width }}>
    ...
    <p className="drawer-note">Saving a key does nothing by itself. Check <b>Enable</b> on a category only when you want to spend that provider’s credits. Uncheck it any time. Local HeartMuLa, covers, and Video Studio stay the default.</p>
