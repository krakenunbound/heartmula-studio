...
export type Song = { id: string; title: string; artist?: string; album?: string; genre?: string; year?: string; track_number?: string; description: string; lyrics: string; english_translation?: string; lyrics_language?: string; timed_lyrics?: TimedLyrics | null; instrumental: boolean; seed: number | null; duration?: number; requested_duration?: number; auto_duration?: boolean; steps?: number; cfg?: number; top_k?: number; tiled_decode?: boolean; exclude_styles?: string; vocal_gender?: "auto" | "female" | "male"; prompt_tokens?: number; voice_slots?: VoiceSlots; voice_snapshots?: VoiceProfile[]; audio_url: string; original_audio_url?: string | null; cover_url?: string | null; cover_error?: string | null; stems?: string[]; studio?: StudioSession; studio_imports?: StudioImport[]; studio_mixes?: { file: string; variant: string; created_at: string }[]; created_at: string; folder: string; folder_name: string };
